...
import { createDefaultTools, createListDatabaseSchemasTool, createQueryDatabaseTool, createReportTools } from "./pi/tools.js"
...
class PiAgentSession implements AgentSession {
	...
	constructor(opts: AgentSessionOpts) {
		...
		const reportTools = createReportTools(opts.toolsEnabled)
		const customTools = [
			...reportTools,
